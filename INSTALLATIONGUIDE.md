...
This modlist takes up roughly 91GB of hard drive space (62GB installation with 29GB of downloads) and will likely take a few hours to download depending on your internet speed. It is recommended that you install it on a solid-state drive for optimal performance. You will run into very long loading times and stuttering with a standard hard disk drive. 
