...
1.1.1.<ins>**1**</ins> = PATCH update that IS savegame compatible
...
Join [Tate Taylor's community Discord server](https://discord.com/servers/tate-s-corgi-condo-678433649430888448){:target="_blank" rel="noopener"} for individual help and guidance.
