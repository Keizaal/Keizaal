...
Due to the large number of resources I needed to dedicate to making Wyrmstooth and Bruma compatible and consistent with the base game, they have both been cut. Both mods happen outside of the rest of Skyrim, literally and metaphorically, and oftentimes I’d notice that players didn’t really interact with them much because there's already so much to do in Skyrim.
